...
def collate_fn(batches):
    ...
    return pixel_values, questions, answers, indexes, internvl_pixel_values
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        outputs = []
        for pixel_values, questions, answers, indexes, internvl_pixel_values in tqdm(dataloader):
        ...
        if torch.distributed.get_rank() == 0:
            ...
            cmd = f'python internvl/eval/seed/calculation.py --image_result_file {output_path}'
            os.system(cmd)
