...
def collate_fn(batches):
    ...
    return pixel_values, questions, annotations, image_paths,internvl_pixel_values


class VQADataset(torch.utils.data.Dataset):

    def __init__(self, root, prompt, input_size=224, dynamic_image_size=False,
                 use_thumbnail=False, max_num=6,min_num=1,use_thumbnail_=None):
    ...
    def __getitem__(self, idx):
        ...
        # internvl_images = dynamic_preprocess(ori_image, min_num=4, max_num=12,image_size=448, use_thumbnail=True)
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        outputs = []
        for pixel_values, questions, annotations, image_paths, internvl_pixel_values in tqdm(dataloader):
        ...
        if torch.distributed.get_rank() == 0:
            ...
            cmd = 'python internvl/eval/tiny_lvlm/calculate_score.py ' \
