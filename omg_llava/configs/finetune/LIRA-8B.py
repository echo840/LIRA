...
from omg_llava.model import LIRA
...
#######################################################################
# Model
llm_name_or_path = '/home/kas/data/llm/internvl8b'  # Please change to your own path
pretrained_pth = "/home/kas/lz_new/omginternvl/saved_path/dream/8b/pretrain_8b.pth"
...
internvl2_dataset = dict(
    type=LLaVADataset,
    data_path=internvl2_datapath,
    image_folder=internvl2_folder,
    tokenizer=tokenizer,
    image_processor=image_processor,
    dataset_map_fn=llava_map_fn,
    template_map_fn=dict(
...
glamm_refcocog_dataset_highlight = dict(
    type=RefCOCOgGCGDataset,
    data_path=refcocog_ann_file_highlight,
...
glamm_grandf_dataset_highlight = dict(
    type=GranDfGCGDataset,
    data_path=grandf_ann_file_highlight,
...
glamm_psg_dataset_highlight = dict(
    type=OpenPsgGCGDataset,
    data_path=psg_ann_file_highlight,
...
glamm_flickr_dataset_highlight = dict(
    type=FlickrGCGDataset,
    data_path=flickr_ann_file_highlight,
...
referring_seg_refcoco_dataset_highlight = dict(
    type=RefcocoReferringSegDataset,
    data_path=referring_refcoco_data_path_highlight,
...
referring_seg_refcoco_plus_dataset_highlight = dict(
    type=Refcoco_plus_ReferringSegDataset,
    data_path=referring_refcoco_plus_data_path_highlight,
...
referring_seg_refcocog_dataset_highlight = dict(
    type=Refcocog_ReferringSegDataset,
    data_path=referring_refcocog_data_path_highlight,
...
train_dataset = dict(
    type=CombineDataset,
    datasets_cfgs=[internvl2_dataset,
                referring_seg_refcoco_dataset_highlight, referring_seg_refcoco_plus_dataset_highlight,
                referring_seg_refcocog_dataset_highlight, 
                referring_seg_refcoco_dataset_highlight, referring_seg_refcoco_plus_dataset_highlight,
                referring_seg_refcocog_dataset_highlight,
                referring_seg_refcoco_dataset_highlight, referring_seg_refcoco_plus_dataset_highlight,
                referring_seg_refcocog_dataset_highlight,
                glamm_refcocog_dataset_highlight, 
                glamm_flickr_dataset_highlight, glamm_grandf_dataset_highlight, glamm_psg_dataset_highlight
                ],)
