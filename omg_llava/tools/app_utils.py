...
description = """
**Usage** : <br>
&ensp;(1) For **Grounded Caption Generation** Interleaved Segmentation, input prompt like: *"Could you please give me a detailed description of the image? Please respond with interleaved segmentation masks for the corresponding parts of the answer."* <br>
&ensp;(2) For **Segmentation Output**, input prompt like: *"Please segment xxx."* <br>
...
def show_mask_pred_new(image, masks):
    selected_colors = []
