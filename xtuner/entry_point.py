...
MODES = ('list-cfg', 'copy-cfg', 'log-dataset', 'check-custom-dataset',
         ...
         'refcoco_omg_seg_llava','vrp_omg_seg_internvl',
...
def vrp_omg_seg_internvl():
    from omg_llava.tools import vrp_omg_seg_internvl
    return vrp_omg_seg_internvl.__file__
...
modes = {
    ...
    'vrp_omg_seg_internvl': vrp_omg_seg_internvl,
